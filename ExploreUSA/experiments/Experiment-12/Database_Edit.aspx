    ...
    <form id="form1" runat="server">
        <div class="pad">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <p>
                        ASP: Editable Table:<br>
                        <br>
                        This is a database experimented to demonstrate Editable tables 
                        This experiment demonstrates updating the values to the database directly from the table.
                        The gridview is displayed from database, Grid View makes use of the SqlDataSource to access the table.
                        and has an "EnableEditing" set to true 
                        By clicking on the edit button one can edit the record and update it simultanoulsy. 
                        The tables are responisve and change of color of a row when you hover on it.

                    </p>

                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSource1" EmptyDataText="There are no data records to display." CssClass="table-responsive table-hover table-bordered table-striped">
                        <Columns>
            ...
            <div>
                <p>
                    <b>View Source: </b>
                    <a href="../../fileview/default.aspx?~/experiments/Experiment-12/Database_Edit.aspx" target="_blank">ASPX Source</a>|
